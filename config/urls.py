...
urlpatterns = [
    ...
    path('api/v1/', include('saas.accounts.urls')),
    path('api/v1/devices/', include('noc.devices.urls')),
    path('api/v1/fiber-routes/', include('noc.topology.urls')),
    path('api/v1/alerts/', include('noc.alerts.urls')),
